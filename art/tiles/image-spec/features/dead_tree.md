# Dead Tree Feature Image Generation Prompt

Generate Realm image sheets for **dead tree feature**.

## Art Brief

- Asset group: features
- Asset id: dead_tree
- Visual design: transparent upright dead-tree cluster anchored to tile centre
...
- row 1, column 1: `full` - dead tree wood resource with grey trunks and moss, full resource amount, abundant and untouched
- row 1, column 2: `mostly_full` - dead tree wood resource with grey trunks and moss, mostly full resource amount, slightly reduced
- row 2, column 1: `mostly_empty` - dead tree wood resource with grey trunks and moss, mostly empty resource amount, sparse but still readable
- row 2, column 2: `depleted` - dead tree wood resource with grey trunks and moss, fully depleted dead-tree resource: broken stumps and fallen limbs on dirt
...
- Grid: 2 by 2
  ...
  - row 2, column 2: dead tree wood resource with grey trunks and moss, fully depleted dead-tree resource: broken stumps and fallen limbs on dirt
