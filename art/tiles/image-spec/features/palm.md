# Palm Feature Image Generation Prompt

Generate Realm image sheets for **palm feature**.

## Art Brief

- Asset group: features
- Asset id: palm
- Visual design: transparent upright palm grove anchored to tile centre over sand
...
- row 1, column 1: `full` - palm grove wood resource, full resource amount, abundant and untouched
- row 1, column 2: `mostly_full` - palm grove wood resource, mostly full resource amount, slightly reduced
- row 2, column 1: `mostly_empty` - palm grove wood resource, mostly empty resource amount, sparse but still readable
- row 2, column 2: `depleted` - palm grove wood resource, fully depleted palm grove: cut stumps, fallen fronds, and exposed sand/dirt
...
Slot order:
- Grid: 2 by 2
  - row 1, column 1: palm grove wood resource, full resource amount, abundant and untouched
  - row 1, column 2: palm grove wood resource, mostly full resource amount, slightly reduced
  - row 2, column 1: palm grove wood resource, mostly empty resource amount, sparse but still readable
  - row 2, column 2: palm grove wood resource, fully depleted palm grove: cut stumps, fallen fronds, and exposed sand/dirt
