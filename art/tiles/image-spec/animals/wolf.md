...
- row 1, column 3: `prowl` frame 00 - prowl
- row 1, column 4: `prowl` frame 01 - prowl
- row 2, column 1: `attack` frame 00 - attack
- row 2, column 2: `attack` frame 01 - attack
- row 2, column 3: `winter_aggressive_variant_optional` frame 00 - winter-aggressive variant optional
- row 2, column 4: `winter_aggressive_variant_optional` frame 01 - winter-aggressive variant optional
