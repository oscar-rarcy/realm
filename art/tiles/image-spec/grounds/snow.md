# Snow Ground Image Generation Prompt

Generate Realm image sheets for **snow ground**.

## Art Brief

- Asset group: grounds
- Asset id: snow
- Visual design: top-down square fully snow-covered replacement floor
...
Slab side material for `snow`: mostly snow-white and blue-grey side material, with dirty earth only in chipped or thawed spots; patchy states should let snow and exposed ground meet naturally at the bevel.
...
- row 1, column 1: `winter_default` - default snow cover, winter biome or fully snow-covered replacement terrain
- row 1, column 2: `snowfall_frame_1` - snow cover, falling snow interaction frame 1 with small snow puffs or fresh specks
- row 1, column 3: `snowfall_frame_2` - snow cover, falling snow interaction frame 2 with shifted snow puffs or fresh specks
- row 2, column 1: `packed_snow` - packed or wind-smoothed snow with subtle blue-grey dents
- row 2, column 2: `deep_snow` - deep snow blanket with softened terrain detail
- row 2, column 3: `thaw_slush` - dirty thawing slush with grass or earth beginning to show
- row 3, column 1: `dirty_edges` - snow cover with muddy or trampled dirty edges
...
Generate Realm snow ground image sheets. Use top-down square 3D terrain slabs that fill the whole square and match the approved Realm grass reference geometry: continuous top material, subtle bevel, worn corners, and dark contact shadow; side material guidance for snow: mostly snow-white and blue-grey side material, with dirty earth only in chipped or thawed spots; patchy states should let snow and exposed ground meet naturally at the bevel. Create one tile for each of the 7 listed states or variants. The default state is winter_default.  Order items left to right and top to bottom within each sheet. Use clean readable watercolor map-ground styling, stable scale, clear gutters, no text labels, no numbers, no watermark, and no cropped artwork. Use opaque full-square slab art in each cell, with the same physical 3D terrain-tile sides, muted chipped worn corners, and dark contact shadow as the approved Realm grass reference; keep clear gutters between cells.

Slot order:
- Grid: 3 by 3
  - row 1, column 1: default snow cover, winter biome or fully snow-covered replacement terrain
  - row 1, column 2: snow cover, falling snow interaction frame 1 with small snow puffs or fresh specks
  - row 1, column 3: snow cover, falling snow interaction frame 2 with shifted snow puffs or fresh specks
  - row 2, column 1: packed or wind-smoothed snow with subtle blue-grey dents
  - row 2, column 2: deep snow blanket with softened terrain detail
  - row 2, column 3: dirty thawing slush with grass or earth beginning to show
  - row 3, column 1: snow cover with muddy or trampled dirty edges
