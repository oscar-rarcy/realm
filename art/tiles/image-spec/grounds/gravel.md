# Gravel Ground Image Generation Prompt

Generate Realm image sheets for **gravel ground**.
...
- row 1, column 1: `spring` - gravel terrain, spring: fresh, recovering, greener look
- row 1, column 2: `summer` - gravel terrain, summer: full growth or dry high-sun look
- row 2, column 1: `autumn` - gravel terrain, autumn: muted, yellowing, leaf-littered, or spent look
- row 2, column 2: `winter` - winter: gravel with frost and patchy snow between stones
...
Slot order:
- Grid: 2 by 2
  - row 1, column 1: gravel terrain, spring: fresh, recovering, greener look
  - row 1, column 2: gravel terrain, summer: full growth or dry high-sun look
  - row 2, column 1: gravel terrain, autumn: muted, yellowing, leaf-littered, or spent look
  - row 2, column 2: winter: gravel with frost and patchy snow between stones
