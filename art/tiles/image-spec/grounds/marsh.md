# Marsh Ground Image Generation Prompt

Generate Realm image sheets for **marsh ground**.

## Art Brief

- Asset group: grounds
- Asset id: marsh
- Visual design: top-down square wet marsh floor, puddled and slow-looking but not an upright reed feature
...
Slab side material for `marsh`: dark green-brown wet peat side material with muddy olive vegetation tones; not clean grass and not grey stone.
...
- row 1, column 1: `spring` - marsh wet ground, spring: fresh, recovering, greener look
- row 1, column 2: `summer` - marsh wet ground, summer: full growth or dry high-sun look
- row 1, column 3: `autumn` - marsh wet ground, autumn: muted, yellowing, leaf-littered, or spent look
- row 2, column 1: `winter` - winter: marsh wet ground frozen with frost and snow caught in vegetation
- row 2, column 2: `rain_frame_1` - marsh wet ground, rain reaction frame 1 with small splash or wet-sheen details
- row 2, column 3: `rain_frame_2` - marsh wet ground, rain reaction frame 2 with shifted splash or wet-sheen details
- row 3, column 1: `storm_frame_1` - marsh wet ground, storm reaction frame 1 with heavier splash, chop, wet-sheen, or steam details
- row 3, column 2: `storm_frame_2` - marsh wet ground, storm reaction frame 2 with shifted heavier splash, chop, wet-sheen, or steam details
...
- Grid: 3 by 3
  ...
  - row 2, column 1: winter: marsh wet ground frozen with frost and snow caught in vegetation
  - row 2, column 2: marsh wet ground, rain reaction frame 1 with small splash or wet-sheen details
  - row 2, column 3: marsh wet ground, rain reaction frame 2 with shifted splash or wet-sheen details
  - row 3, column 1: marsh wet ground, storm reaction frame 1 with heavier splash, chop, wet-sheen, or steam details
  - row 3, column 2: marsh wet ground, storm reaction frame 2 with shifted heavier splash, chop, wet-sheen, or steam details
