# Meadow Ground Image Generation Prompt

Generate Realm image sheets for **meadow ground**.

## Art Brief

- Asset group: grounds
- Asset id: meadow
- Visual design: top-down square lush meadow floor with softer vegetation than grass
...
Slab side material for `meadow`: soft meadow green side material with muted earth-green and tan undertones; small flower colours stay on the top face, not on the side faces.
...
- row 1, column 1: `spring` - lush meadow ground, spring: fresh, recovering, greener look
- row 1, column 2: `summer` - lush meadow ground, summer: full growth or dry high-sun look
- row 2, column 1: `autumn` - lush meadow ground, autumn: muted, yellowing, leaf-littered, or spent look
- row 2, column 2: `winter` - winter: meadow with frost and patchy snow
...
Generate Realm meadow ground image sheets. Use top-down square 3D terrain slabs that fill the whole square and match the approved Realm grass reference geometry: continuous top material, subtle bevel, worn corners, and dark contact shadow; side material guidance for meadow: soft meadow green side material with muted earth-green and tan undertones; small flower colours stay on the top face, not on the side faces. Create one tile for each of the 4 listed states or variants. The default state is spring.  Order items left to right and top to bottom within each sheet. Use clean readable watercolor map-ground styling, stable scale, clear gutters, no text labels, no numbers, no watermark, and no cropped artwork. Use opaque full-square slab art in each cell, with the same physical 3D terrain-tile sides, muted chipped worn corners, and dark contact shadow as the approved Realm grass reference; keep clear gutters between cells.

Slot order:
- Grid: 2 by 2
  - row 1, column 1: lush meadow ground, spring: fresh, recovering, greener look
  - row 1, column 2: lush meadow ground, summer: full growth or dry high-sun look
  - row 2, column 1: lush meadow ground, autumn: muted, yellowing, leaf-littered, or spent look
  - row 2, column 2: winter: meadow with frost and patchy snow
