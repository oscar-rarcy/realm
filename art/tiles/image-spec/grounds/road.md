# Road Ground Image Generation Prompt

Generate Realm image sheets for **road ground**.

## Art Brief

- Asset group: grounds
- Asset id: road
- Visual design: top-down square packed road or cobble movement route floor
- Projection: top-down square source tile, projected into an isometric diamond by the game
- Footprint: 1 by 1 tile
- Directions: tile
- Default state: `spring_clear`
...
- row 1, column 1: `spring_clear` - stone or packed road in clear spring weather
- row 1, column 2: `summer_dry` - stone or packed road in dry summer weather
- row 1, column 3: `autumn_leaf_litter` - stone or packed road with autumn leaf litter at the edges
- row 2, column 1: `winter_snow_edges` - stone or packed road with snow gathered on edges but route still readable
- row 2, column 2: `rain_frame_1` - stone or packed road, rain reaction frame 1 with small splash or wet-sheen details
- row 2, column 3: `rain_frame_2` - stone or packed road, rain reaction frame 2 with shifted splash or wet-sheen details
- row 3, column 1: `storm_frame_1` - stone or packed road, storm reaction frame 1 with heavier splash, chop, wet-sheen, or steam details
- row 3, column 2: `storm_frame_2` - stone or packed road, storm reaction frame 2 with shifted heavier splash, chop, wet-sheen, or steam details
...
Generate Realm road ground image sheets. Use top-down square source tiles that tile cleanly at the edges and remain readable after isometric projection. Create one tile for each of the 8 listed states or variants. The default state is spring_clear.  Order items left to right and top to bottom within each sheet. Use clean readable small-RTS art, stable scale, clear gutters, no text labels, no numbers, no watermark, and no cropped artwork. Use opaque edge-to-edge tile art in each cell, with clear gutters between cells and no transparent border.

Slot order:
- Grid: 3 by 3
  - row 1, column 1: stone or packed road in clear spring weather
  - row 1, column 2: stone or packed road in dry summer weather
  - row 1, column 3: stone or packed road with autumn leaf litter at the edges
  - row 2, column 1: stone or packed road with snow gathered on edges but route still readable
  - row 2, column 2: stone or packed road, rain reaction frame 1 with small splash or wet-sheen details
  - row 2, column 3: stone or packed road, rain reaction frame 2 with shifted splash or wet-sheen details
  - row 3, column 1: stone or packed road, storm reaction frame 1 with heavier splash, chop, wet-sheen, or steam details
  - row 3, column 2: stone or packed road, storm reaction frame 2 with shifted heavier splash, chop, wet-sheen, or steam details
