# Hills Ground Image Generation Prompt

Generate Realm image sheets for **hills ground**.

## Art Brief

- Asset group: grounds
- Asset id: hills
- Visual design: top-down square rolling hill and ridge floor, not a tall upright mountain sprite
...
Slab side material for `hills`: earthy green-brown hillside side material with grass-covered top fading into compacted soil and shaded ridge chips.
...
- row 1, column 1: `spring` - rolling hill terrain, spring: fresh, recovering, greener look
- row 1, column 2: `summer` - rolling hill terrain, summer: full growth or dry high-sun look
- row 2, column 1: `autumn` - rolling hill terrain, autumn: muted, yellowing, leaf-littered, or spent look
- row 2, column 2: `winter` - winter: rolling hills with snow on ridges and shaded exposed earth
...
Generate Realm hills ground image sheets. Use top-down square 3D terrain slabs that fill the whole square and match the approved Realm grass reference geometry: continuous top material, subtle bevel, worn corners, and dark contact shadow; side material guidance for hills: earthy green-brown hillside side material with grass-covered top fading into compacted soil and shaded ridge chips. Create one tile for each of the 4 listed states or variants. The default state is spring.  Order items left to right and top to bottom within each sheet. Use clean readable watercolor map-ground styling, stable scale, clear gutters, no text labels, no numbers, no watermark, and no cropped artwork. Use opaque full-square slab art in each cell, with the same physical 3D terrain-tile sides, muted chipped worn corners, and dark contact shadow as the approved Realm grass reference; keep clear gutters between cells.

Slot order:
- Grid: 2 by 2
  - row 1, column 1: rolling hill terrain, spring: fresh, recovering, greener look
  - row 1, column 2: rolling hill terrain, summer: full growth or dry high-sun look
  - row 2, column 1: rolling hill terrain, autumn: muted, yellowing, leaf-littered, or spent look
  - row 2, column 2: winter: rolling hills with snow on ridges and shaded exposed earth
