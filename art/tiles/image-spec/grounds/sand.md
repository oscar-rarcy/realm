# Sand Ground Image Generation Prompt

Generate Realm image sheets for **sand ground**.

## Art Brief

- Asset group: grounds
- Asset id: sand
- Visual design: top-down square sandy floor for desert and beach areas
...
Slab side material for `sand`: warm tan, ochre, and shaded sandy side material, like compressed sand with darker worn underside chips.
...
- row 1, column 1: `base_clear` - default sandy ground; use this as the season-invariant default
- row 1, column 2: `rain_frame_1` - sandy ground, rain reaction frame 1 with small splash or wet-sheen details
- row 2, column 1: `rain_frame_2` - sandy ground, rain reaction frame 2 with shifted splash or wet-sheen details
- row 2, column 2: `wind_scoured` - sandy ground with wind-scoured grain variation
...
Generate Realm sand ground image sheets. Use top-down square 3D terrain slabs that fill the whole square and match the approved Realm grass reference geometry: continuous top material, subtle bevel, worn corners, and dark contact shadow; side material guidance for sand: warm tan, ochre, and shaded sandy side material, like compressed sand with darker worn underside chips. Create one tile for each of the 4 listed states or variants. The default state is base_clear.  Order items left to right and top to bottom within each sheet. Use clean readable watercolor map-ground styling, stable scale, clear gutters, no text labels, no numbers, no watermark, and no cropped artwork. Use opaque full-square slab art in each cell, with the same physical 3D terrain-tile sides, muted chipped worn corners, and dark contact shadow as the approved Realm grass reference; keep clear gutters between cells.

Slot order:
- Grid: 2 by 2
  - row 1, column 1: default sandy ground; use this as the season-invariant default
  - row 1, column 2: sandy ground, rain reaction frame 1 with small splash or wet-sheen details
  - row 2, column 1: sandy ground, rain reaction frame 2 with shifted splash or wet-sheen details
  - row 2, column 2: sandy ground with wind-scoured grain variation
