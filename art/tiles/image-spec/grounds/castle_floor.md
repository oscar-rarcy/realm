# Castle Floor Ground Image Generation Prompt

Generate Realm image sheets for **castle floor ground**.

## Art Brief

- Asset group: grounds
- Asset id: castle_floor
- Visual design: top-down square old castle paving or fortification floor
...
Slab side material for `castle_floor`: cut stone and paving side material, with individual paver edges, grey-beige worn chips, and moss only in cracks.
...
- row 1, column 1: `spring` - old castle floor paving, spring: fresh, recovering, greener look
- row 1, column 2: `summer` - old castle floor paving, summer: full growth or dry high-sun look
- row 2, column 1: `autumn` - old castle floor paving, autumn: muted, yellowing, leaf-littered, or spent look
- row 2, column 2: `winter` - winter: old paving with frost, snow in cracks, and dirty exposed stones
...
Generate Realm castle floor ground image sheets. Use top-down square 3D terrain slabs that fill the whole square and match the approved Realm grass reference geometry: continuous top material, subtle bevel, worn corners, and dark contact shadow; side material guidance for castle_floor: cut stone and paving side material, with individual paver edges, grey-beige worn chips, and moss only in cracks. Create one tile for each of the 4 listed states or variants. The default state is spring.  Order items left to right and top to bottom within each sheet. Use clean readable watercolor map-ground styling, stable scale, clear gutters, no text labels, no numbers, no watermark, and no cropped artwork. Use opaque full-square slab art in each cell, with the same physical 3D terrain-tile sides, muted chipped worn corners, and dark contact shadow as the approved Realm grass reference; keep clear gutters between cells.

Slot order:
- Grid: 2 by 2
  - row 1, column 1: old castle floor paving, spring: fresh, recovering, greener look
  - row 1, column 2: old castle floor paving, summer: full growth or dry high-sun look
  - row 2, column 1: old castle floor paving, autumn: muted, yellowing, leaf-littered, or spent look
  - row 2, column 2: winter: old paving with frost, snow in cracks, and dirty exposed stones
