# Ram Image Generation Prompt

Generate one Realm sprite reference sheet per direction for **Ram**.

## Art Brief

- Source role: building-only siege
- Visual design: Covered battering ram with log snout, wheels, dark hide/wood cover
...
- row 1, column 1: `idle` frame 00 - idle ram with one visible human operator at the handles or cover opening
- row 1, column 2: `idle` frame 01 - idle ram with one visible human operator at the handles or cover opening
- row 1, column 3: `roll` frame 00 - operator walking with the wheeled ram as it rolls
- row 1, column 4: `roll` frame 01 - operator walking with the wheeled ram as it rolls
- row 2, column 1: `impact_ramming` frame 00 - operator bracing the ram during impact; no projectile or extra crew
- row 2, column 2: `impact_ramming` frame 01 - operator bracing the ram during impact; no projectile or extra crew
- row 2, column 3: `damaged_alert` frame 00 - damaged/alert
- row 2, column 4: `damaged_alert` frame 01 - damaged/alert
