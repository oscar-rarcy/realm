# Catapult Image Generation Prompt

Generate one Realm sprite reference sheet per direction for **Catapult**.

## Art Brief

- Source role: siege ranged, splash, standoff
- Visual design: Wood-and-iron torsion/sling machine; exaggerated throwing arm
...
- row 1, column 3: `load` - load
- row 2, column 1: `fire` - fire
- row 2, column 2: `recoil` - recoil
