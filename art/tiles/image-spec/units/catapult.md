...
- Add a white diagonal stripe running from top left to bottom right on the small pennants, and the side shield plaques.
...
- `catapult_boulder`: `art/tiles/image-spec/ammunition/catapult_boulder.md`
