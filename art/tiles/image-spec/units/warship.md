# Warship Image Generation Prompt

Generate one Realm sprite reference sheet per direction for **Warship**.

## Art Brief

- Source role: naval combat
- Visual design: Larger longboat/war galley silhouette, shielded sides
...
- `warship_arrow_volley`: `art/tiles/image-spec/projectiles/warship_arrow_volley.md`
...
- row 2, column 1: `fire_arrow_volley` frame 00 - fire or arrow-volley follow-through; do not draw released arrows or airborne shot in the ship frame
- row 2, column 2: `fire_arrow_volley` frame 01 - fire or arrow-volley follow-through; do not draw released arrows or airborne shot in the ship frame
