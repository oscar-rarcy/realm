# Flowers Decal Image Generation Prompt

Generate Realm image sheets for **flowers decal**.

## Art Brief

- Asset group: decals
- Asset id: flowers
- Visual design: transparent low wildflower overlay that sits flat on grass or meadow
...
- Generation slot target before crop: about 256 by 256 px per accepted decal.
...
- row 1, column 1: `spring` - wildflower ground decal, spring: fresh, recovering, greener look
- row 1, column 2: `summer` - wildflower ground decal, summer: full growth or dry high-sun look
- row 2, column 1: `autumn` - wildflower ground decal, autumn: muted, yellowing, leaf-littered, or spent look
- row 2, column 2: `winter` - winter: dormant flower stems with patchy snow
...
Generate Realm flowers decal image sheets. Use transparent low/flat overlay decals that sit on the ground and do not imply an independent blocking object. Create one decal for each of the 4 listed states or variants. The default state is spring.  Order items left to right and top to bottom within each sheet. Use clean readable simplified hand-painted ground-decal styling, stable scale, clear gutters, no text labels, no numbers, no watermark, and no cropped artwork. Use transparent background, or a single flat #ff00ff magenta background if transparency is not available.

Slot order:
- Grid: 2 by 2
  - row 1, column 1: wildflower ground decal, spring: fresh, recovering, greener look
  - row 1, column 2: wildflower ground decal, summer: full growth or dry high-sun look
  - row 2, column 1: wildflower ground decal, autumn: muted, yellowing, leaf-littered, or spent look
  - row 2, column 2: winter: dormant flower stems with patchy snow
