# Dirt Scuffs Decal Image Generation Prompt

Generate Realm image sheets for **dirt scuffs decal**.

## Art Brief

- Asset group: decals
- Asset id: dirt_scuffs
- Visual design: transparent sparse dirt scuffs for low wear and settlement edges
...
- row 1, column 1: `sparse` - sparse dirt scuffs
- row 1, column 2: `medium` - medium dirt scuffs
- row 2, column 1: `heavy` - heavy dirt scuffs
