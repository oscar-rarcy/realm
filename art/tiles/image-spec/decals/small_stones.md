# Small Stones Decal Image Generation Prompt

Generate Realm image sheets for **small stones decal**.

## Art Brief

- Asset group: decals
- Asset id: small_stones
- Visual design: transparent low scattered-stone overlay for rocky, dirt, and path variation
...
Generate **one decal for each listed state or variant**. There are 3 item(s). Each image may contain at most **16 items** in a **4 by 4** grid.
...
- row 1, column 1: `base_clear` - small flat scattered stones
- row 1, column 2: `frost` - small stones with frost
- row 2, column 1: `snow_dusted` - small stones with light snow dusting
