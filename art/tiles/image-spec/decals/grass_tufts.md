# Grass Tufts Decal Image Generation Prompt

Generate Realm image sheets for **grass tufts decal**.

## Art Brief

- Asset group: decals
- Asset id: grass_tufts
- Visual design: transparent low grass tuft overlay for natural ground variation
...
- row 1, column 1: `spring` - small grass tufts, spring: fresh, recovering, greener look
- row 1, column 2: `summer` - small grass tufts, summer: full growth or dry high-sun look
- row 2, column 1: `autumn` - small grass tufts, autumn: muted, yellowing, leaf-littered, or spent look
- row 2, column 2: `winter` - winter: small frosted grass tufts poking through snow
...
Generate Realm grass tufts decal image sheets. Use transparent low/flat overlay decals that sit on the ground and do not imply an independent blocking object. Team colour is not required. Create one decal for each listed state or variant. The default state is spring. If there are more than 16 items, split them across multiple images, each image using a 4 by 4 grid. Order items left to right and top to bottom within each sheet. Use clean readable small-RTS art, stable scale, clear gutters, no text labels, no numbers, no watermark, and no cropped artwork. Use transparent background, or a single flat #ff00ff magenta background if transparency is not available.

Slot order:
- Sheet 1 of 1: 2 by 2 grid
  - row 1, column 1: small grass tufts, spring: fresh, recovering, greener look
  - row 1, column 2: small grass tufts, summer: full growth or dry high-sun look
  - row 2, column 1: small grass tufts, autumn: muted, yellowing, leaf-littered, or spent look
  - row 2, column 2: winter: small frosted grass tufts poking through snow
