# House Image Generation Prompt

Generate a Realm sprite reference sheet for **House**.

## Art Brief

- Source role: supply +5, garrison 4, defensive if garrisoned
- Visual design: Thatch/wood cottage, chimney, small fenced yard
...
- row 1, column 2: `construction` - construction
...
- row 3, column 1: `garrison_firing` - building body visibly reacting while its garrison fires
