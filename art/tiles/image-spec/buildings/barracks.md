# Barracks Image Generation Prompt

Generate a Realm sprite reference sheet for **Barracks**.

## Art Brief

- Source role: trains militia, archer, catapult, ram
- Visual design: Long timber hall with weapon racks and practice yard
