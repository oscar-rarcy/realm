# Blacksmith Image Generation Prompt

Generate a Realm sprite reference sheet for **Blacksmith**.

## Art Brief

- Source role: research Iron Weapons/Crossbows; speeds training
- Visual design: Forge, chimney, anvil yard, glowing coals
...
- row 1, column 2: `researching` - researching
...
- row 3, column 1: `researching_iron_weapons` - blacksmith visibly researching Iron Weapons
- row 3, column 2: `researching_crossbows` - blacksmith visibly researching Crossbows
...
- Grid: 4 by 4
  ...
  - row 3, column 1: blacksmith visibly researching Iron Weapons
  - row 3, column 2: blacksmith visibly researching Crossbows
