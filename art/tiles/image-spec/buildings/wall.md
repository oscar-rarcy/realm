# Wall Image Generation Prompt

Generate a Realm sprite reference sheet for **Wall**.

## Art Brief

- Source role: drag-built blocker
- Visual design: Stone wall block that joins cleanly to neighbours
...
Generate **one frame for each state**. There are 16 state(s). Each image may contain at most **16 states** in a **4 by 4** grid.
...
- row 1, column 1: `straight` - straight
- row 1, column 2: `corner` - corner
- row 1, column 3: `t_junction` - T-junction
- row 1, column 4: `cross` - cross
- row 2, column 1: `end_cap` - end-cap
- row 2, column 2: `construction` - construction
- row 2, column 3: `construction_0_foundation` - 0-33 percent construction: foundation footprint and early site materials
- row 2, column 4: `construction_1_frame` - 34-66 percent construction: visible frame and scaffolding
- row 3, column 1: `construction_2_nearly_complete` - 67-99 percent construction: nearly complete shell with final work visible
- row 3, column 2: `complete` - complete usable building
- row 3, column 3: `damaged` - damaged building below half HP, readable but not destroyed
- row 3, column 4: `night_lit` - completed building at night with warm torch, candle, forge, or window light; keep team colour readable
- row 4, column 1: `rain_frame_1` - completed building in rain, wet roof/ground and drip or splash detail frame 1
- row 4, column 2: `rain_frame_2` - completed building in rain, wet roof/ground and drip or splash detail frame 2
- row 4, column 3: `snow_light` - completed building with light snow on roof edges, ledges, and ground contact
- row 4, column 4: `snow_heavy` - completed building with heavy settled snow while silhouette and team colour stay readable
...
Generate sprites for my Realm Wall. The footprint is 1 by 1 tile(s). Team colour is required and the recommended preview player colour is blue (#00AFFF). Use south direction artwork. Create one frame for each of the 16 listed states. Order states left to right and top to bottom within each sheet. Keep the character or building consistent across every slot. Use transparent background, or a single flat #ff00ff magenta background if transparency is not available. Use clean readable small-RTS proportions, stable anchor, clear gutters, no text labels, no numbers, no watermark, and no cropped artwork.

Slot order:
- Grid: 4 by 4
  - row 1, column 1: straight
  - row 1, column 2: corner
  - row 1, column 3: T-junction
  - row 1, column 4: cross
  - row 2, column 1: end-cap
  - row 2, column 2: construction
  - row 2, column 3: 0-33 percent construction: foundation footprint and early site materials
  - row 2, column 4: 34-66 percent construction: visible frame and scaffolding
  - row 3, column 1: 67-99 percent construction: nearly complete shell with final work visible
  - row 3, column 2: complete usable building
  - row 3, column 3: damaged building below half HP, readable but not destroyed
  - row 3, column 4: completed building at night with warm torch, candle, forge, or window light; keep team colour readable
  - row 4, column 1: completed building in rain, wet roof/ground and drip or splash detail frame 1
  - row 4, column 2: completed building in rain, wet roof/ground and drip or splash detail frame 2
  - row 4, column 3: completed building with light snow on roof edges, ledges, and ground contact
  - row 4, column 4: completed building with heavy settled snow while silhouette and team colour stay readable
