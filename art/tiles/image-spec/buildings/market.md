# Market Image Generation Prompt

Generate a Realm sprite reference sheet for **Market**.

## Art Brief

- Source role: passive gold income
- Visual design: Trade stalls, awnings, crates, coin sign
...
- row 1, column 2: `income_sparkle` - income sparkle
