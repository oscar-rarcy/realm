# Mining Camp Image Generation Prompt

Generate a Realm sprite reference sheet for **Mining Camp**.

## Art Brief

- Source role: gold drop-off
- Visual design: Mine hut, timber supports, ore carts, lantern
