# Church Image Generation Prompt

Generate a Realm sprite reference sheet for **Church**.

## Art Brief

- Source role: heals nearby, vision
- Visual design: Small stone chapel, cross, stained glass, grave/path
...
Generate **one sprite frame for each listed slot**. There are 13 frame slot(s). Each image may contain at most **16 frame slots** in a **4 by 4** grid.
...
- row 1, column 2: `healing_aura` - healing aura
