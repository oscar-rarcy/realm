# Stable Image Generation Prompt

Generate a Realm sprite reference sheet for **Stable**.

## Art Brief

- Source role: trains knight
- Visual design: Long stable block, hay, paddock fence, horse posts
- Projection: upright sprite anchored over projected isometric map tiles
- Footprint: 3 by 2 tile(s)
- Directions: south
...
- row 3, column 1: `training_cavalry` - building visibly training cavalry
...
- Grid: 4 by 4
  ...
  - row 3, column 1: building visibly training cavalry
