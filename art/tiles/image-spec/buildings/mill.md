# Mill Image Generation Prompt

Generate a Realm sprite reference sheet for **Mill**.

## Art Brief

- Source role: food drop-off and enables farm harvest
- Visual design: Windmill or waterless hand-mill with grain sacks
...
- row 1, column 2: `operating` - operating
