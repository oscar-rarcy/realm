...
static const ResearchDef DEFS[] = {
    { ResearchId::IronWeapons,   R_IRON_WEAPONS,  100, 100, 940, E_BLACKSMITH, E_NONE,   'i', "Iron",          "Researching Iron Weapons..." },
    { ResearchId::Crossbows,     R_CROSSBOWS,      80,  80, 820, E_BLACKSMITH, E_NONE,   'c', "Crossbows",     "Researching Crossbows..." },
    { ResearchId::Pikes,         R_PIKES,         100, 100, 900, E_BLACKSMITH, E_NONE,   'p', "Pikes",         "Researching Pikes..." },
    { ResearchId::Counterweight, R_COUNTERWEIGHT, 120, 150, 980, E_BLACKSMITH, E_CASTLE, 'w', "Counterweight", "Researching Counterweight..." },
    { ResearchId::PlateHelm,     R_PLATE_HELM,    120, 100, 980, E_BLACKSMITH, E_NONE,   'h', "Helm",          "Researching Plate Helm..." },
};
